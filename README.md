...
Most plugin developers will want `grav-api-admin-next-integration`. Reach for the narrower `grav-api-integration` only when you're sure no admin UI work is needed.
